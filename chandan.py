...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv(r"C:\Users\ROHAN\Desktop\Recomed\Testing.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv(r"C:\Users\ROHAN\Desktop\Recomed\Training.csv")
...
# Heading
w2 = Label(root, justify=LEFT, text="+RECOMED-Disease Predictor+", fg="white", bg="BLUE")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="TENSOR TROOPERS", fg="white", bg="blue")
...
dst = Button(root, text="DecisionTree", command=DecisionTree,bg="BLUE",fg="yellow")
dst.grid(row=8, column=3,padx=10)

rnf = Button(root, text="Randomforest", command=randomforest,bg="green",fg="yellow")
rnf.grid(row=9, column=3,padx=10)

lr = Button(root, text="NaiveBayes", command=NaiveBayes,bg="RED",fg="yellow")
